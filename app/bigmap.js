    ...
    var self = this;
        ...
        .enter().append("path")
            ...
            .style("fill", function(d){
                if (self.race == 0) {
                    if (d.properties.STUSPS == "OR" || d.properties.STUSPS == "WI" || d.properties.STUSPS == "IL" || d.properties.STUSPS == "PA" || d.properties.STUSPS == "NJ" || d.properties.STUSPS == "MA") { return "#0258a0"; }
                    ...
                    else if (d.properties.STUSPS == "WV") { return "#999999"; }
                    else { return "#dddddd"; }
                } else if (self.race == 1) {
                    if (d.properties.STUSPS == "CT" || d.properties.STUSPS == "DC" || d.properties.STUSPS == "HI" || d.properties.STUSPS == "ME" || d.properties.STUSPS == "MD" || d.properties.STUSPS == "MA" || d.properties.STUSPS == "MI" || d.properties.STUSPS == "MN" || d.properties.STUSPS == "NY" || d.properties.STUSPS == "PA" || d.properties.STUSPS == "RI" || d.properties.STUSPS == "TX" || d.properties.STUSPS == "WA"  || d.properties.STUSPS == "WV") { return "#0258a0"; }
                    else if (d.properties.STUSPS == "AL" || d.properties.STUSPS == "AR" || d.properties.STUSPS == "GA" || d.properties.STUSPS == "LA" || d.properties.STUSPS == "MS") { return "#5BBF48"; }
                    else { return "#c0272d"; }
                } else if (self.race == 2) {
                    if (d.properties.STUSPS == "MN" || d.properties.STUSPS == "DC") { return "#0258a0"; }
                    else { return "#c0272d"; }
                } else if (self.race == 3) {
                    if (d.properties.STUSPS == "ND" || d.properties.STUSPS == "MN" || d.properties.STUSPS == "IA" || d.properties.STUSPS == "MO" || d.properties.STUSPS == "CO" || d.properties.STUSPS == "KS" || d.properties.STUSPS == "OK" || d.properties.STUSPS == "LA" || d.properties.STUSPS == "AL" || d.properties.STUSPS == "MS" || d.properties.STUSPS == "TN") { return "#D4CB6A"; }
